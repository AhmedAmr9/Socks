...
//           <div className="w-10 h-10  from-amber-500 to-orange-600 rounded-full flex items-center justify-center">
//             <Image 
//               src="/main6.png" 
//               alt="Socks Logo" 
//               width={24} 
...
//       className="absolute top-4 right-4 text-gray-700 hover:text-amber-600"
//     >
//       ✕
//     </button>
...
//           setIsMenuOpen(false)
//         }}
//         className="text-sm md:lg block w-full text-left py-2 text-gray-700 hover:text-amber-600 transition-colors"
//       >
//         {item.name}
//       </button>
//     ))}
...
//       {/* Side Drawer */}
// <div
//   className={`fixed top-20 right-0 h-[calc(100%-5rem)] w-64 bg-yellow-300 shadow-lg z-50 transform transition-transform duration-300 ease-in-out ${
//     isMenuOpen ? "translate-x-0" : "translate-x-full"
//   }`}
// >
//         <div className="p-6 space-y-6 relative">
