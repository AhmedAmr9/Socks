...
export default function StaffSection() {
  ...
  // Each item width = avatar(130) + gap-12 (~48px)
  const ITEM_SIZE = 178
...
<div className="relative w-full flex items-center justify-center mb-10">
  ...
  <div
    ref={scrollRef}
    className="flex gap-0 ms:gap-6 overflow-x-scroll no-scrollbar scroll-smooth cursor-grab px-10 md:px-0" // padding to leave space for arrows
